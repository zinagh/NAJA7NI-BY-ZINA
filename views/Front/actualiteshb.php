...
$listearticles = $articleC->afficherhandball();
if (isset($_GET['num'])) {
    $num = $_GET['num'];
    if ($num == 1) {
...
<br><br><br><br>
   ...
   <!-- <li>-->
        <?php if ($Previous > 0) :?>
      <a href="actualiteshb.php?page=<?= $Previous; ?>" class="prev"><i class="fas fa-angle-left"></i></a>
   ...
   <!-- </li>-->
    <?php for($i = 1; $i<= $pages; $i++) : ?>
        <?php if($i==$page) :?>
                    <!--<li>---><a href="actualiteshb.php?page=<?= $i; ?>" class="num active"><?= $i; ?></a><!--</li>-->
                    <?php else :?>
                  <!--<li>---><a href="actualiteshb.php?page=<?= $i; ?>" class="num "><?= $i; ?></a><!--</li>--> 
            <?php endif?>
    <?php endfor; ?>
   <!-- <li>-->
    <?php if ($Next <= $pages) :?>
      <a href="actualiteshb.php?page=<?= $Next; ?>"  class="next"><i class="fas fa-angle-right"></i></a>
