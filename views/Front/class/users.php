...
class users
{
...

	{
		...
		$course_id=$_SESSION['course'];  // the session variable is created in question_show.php file
		$right=0;
		$wrong=0;
		$no_answer=0;

		$query=$this->conn->query("select id,answer from question_test where course='$course_id'");
