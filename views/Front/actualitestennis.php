...
<script type="text/javascript" src="https://fr.tutiempo.net/s-widget/l_Jy11xkB1B8DjcQGUKbuDjDDDjWa1L1YFrYEdEsi5a1z"></script>
    ...
    <div><span STYLE="padding:0 0 0 20px;"><?php $html = ""; $url = "http://www.tennisstats247.com/RankingsRssWidget.aspx?langId=5&tournamentTypeId=1";$xml = simplexml_load_file($url); $description = $xml->channel->item->description; $html .= "$description"; 

 $html1 = ""; $url1 = "http://www.tennisstats247.com/RankingsRssWidget.aspx?langId=5&tournamentTypeId=3";$xml1 = simplexml_load_file($url1); $description1 = $xml1->channel->item->description; $html1 .= "$description1"; ?>
</div>
        <?php 
$articleC = new articleC();
$listearticles = $articleC->affichertennis();
if (isset($_GET['num'])) {
    $num = $_GET['num'];
    if ($num == 1) {
