        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div>
                        <?PHP
                        $nbreartC = new articleC();
                      
                            $art = $nbreartC->affichernbrearticle();
...
foreach ($art as $row) {
                            ?>
                                ...
                                <td><?PHP echo $row['nbrart'] ; ?></td> 

                                <?php  $autC = new articleC();
                         $aut = $autC->affichernbreauteur();
                            ?>
                            <?php
                            foreach ($aut as $row) {
                            ?>
...
foreach ($listearticle as $row) {
                         ...
                         $nombrecyc = $cyclismeC->affichernbrecyc();
                            ?>
                            <?php
                            foreach ($nombrecyc as $row) {
                            ?>
                                                                <td><?PHP echo $row['nbrcyc'] ; ?></td> <?php } ?>
                                </tr>
